        ...
        <div tabindex="0" aria-label="footer" class="focus:outline-none py-3 lg:py-16">
            <div class="max-w-7xl mx-auto py-4 px-3 lg:px-8">
                <div class="lg:flex">
                    ...
                    <div class="w-full lg:w-1/3 px-4 lg:px-6 mt-4 lg:mt-0">
                        ...
                        <ul>
                            <li class="mt-6">
                                <div>
                                    ...
                                    <i class="fas fa-map-marker-alt text-white float-left fa-lg mr-3"></i>
                                    <div class="ml-7">
                                        <addresss>
                                            <a class="focus:outline-none focus:underline text-sm lg:text-base leading-none hover:text-brand hover:text-white text-gray-300" href="https://goo.gl/maps/zHnGbhXKxpqaW8Bn8">C/ Sucre, 22 - Bajo Izqda, CP 35008 Las Palmas</a>
                                        </addresss>
                                    </div>
                            ...
                            <li class="mt-6">
                                ...
                                <div class="ml-7">
                                    <a class="focus:outline-none focus:underline text-sm lg:text-base leading-none hover:text-brand hover:text-white text-gray-300" href="mailto:info@servicioselectronicos.com">info@servicioselectronicos.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
