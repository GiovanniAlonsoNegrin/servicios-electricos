    ...
    <div class="max-w-7xl mx-auto px-2 py-1 lg:py-4 sm:px-6 lg:px-8">
        <div class="lg:w-1/2 float-left">
            <div class="w-full lg:w-full mt-4 lg:mt-10">
                <p class="text-white px-2 lg:pl-4 lg:pr-6 mt-12 lg:mt-32 text-xl lg:text-4xl">Especialistas en sistemas de comunicación para los servicios de seguridad y atención de emergencias.</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div id="boxOne" class="mt-10 rounded col-span-2">
                    <div class="w-full px-4 py-1 rounded">
                        <p class="myColor text-lg font-bold">¿Por qué elegirnos?</p>
                        <h1 class="text-gray-900 text-2xl lg:text-4xl mt-4">Brindamos soluciones de TI verdaderamente destacadas para su éxito</h1>
                        <div class="mt-10">
                        ...
                        <div class="mt-10 mb-10">
                            <p class="text-lg">Esto es solo un vistazo, vea <a class="myColor underline" href="{{ route('frontend.services') }}">todas las características</a> de nuestro servicio.</p>
                        </div>
                    </div>
                </div>
            </div>
